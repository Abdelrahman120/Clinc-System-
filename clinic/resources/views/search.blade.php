        ...
        <div class="content">
            <aside class="sideNav">
                ...
                <ul class="nav_links">
                    ...
                    <li class="nav_item"><a href="#"><i class="fas fa-search nav_icon">
                        <a href="/search">
                    </i>Patient search</a></li>
                    <!-- ###################### -->
                    <li class="nav_title">Doctors</li>
                    <li class="nav_item"><a href="#"><i class="fas fa-user-plus nav_icon">
                        <a href="/doctorform">
                    </i>Add Doctor</a></li>
                    <li class="nav_item"><a href="#"><i class="fas fa-users-cog nav_icon"></i>Manage Patients</a></li>
                    ...
                    <li class="nav_item"><a href="#"><i class="fas fa-cog nav_icon"></i>Manage Ambulance</a></li>
                    <li class="nav_item"><a href="#"><i class="fas fa-search nav_icon"></i>Ambulance search</a></li>
