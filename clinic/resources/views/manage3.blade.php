                ...
                <div class="page_content">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <tr>
                            <td>{{$patient->vechile_number}}  </td>
                                <td>{{$patient->vechile_model}}</td>
                                <td>{{$patient->year_made}}</td>
                               
                                <td>{{$patient->driver_name}}</td>
                                <td>{{$patient->driver_license}}</td>
                                <td>{{$patient->driver_phone}}</td>
                                <td>{{$patient->vechile_type}}</td>
                            </tr>
                            @endforeach
                          </table>
