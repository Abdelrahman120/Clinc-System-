...
<head>
    ...
    <link rel="stylesheet" href=style/patientform.css>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="a">
                                    ...
                                    <form method="post" action="/patientform">
                                        @csrf
                                    <div class="form-field1">
                                        ...
                                        @if(session('error')) <p class="error">{{ session('error') }}</p> @endif
                                            ...
                                            <div class="box-content1">
                                            <label class="details1" for="Gender"><b>Gender</b></label>   
                                        <select name="gender"   id="gender">            
                                            ...
                                            <div class="box-content1"> 
                                            <label class="details1"  for="Date of birth"><b>Date of birth</b></label>
