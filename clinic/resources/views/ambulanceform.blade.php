...
<head>
    ...
    <link rel="stylesheet" href="style/ambulanceform.css">
                        ...
                        <div class="row">
                            ...
                            <div class="a">
                                <div class="box1">
                                    ...
                                    <form method="POST" action="/ambulanceform">
                                        @csrf
                                        <div class="form-field1">
                                            <div class="box-content1">
                                                <label class="details1"for="  Vechile Number"><b>Vechile
                                                        Number</b></label>
                                                <input type="text" name="vechile_number"required>
                                                @error('vechile_number') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <label class="details1"for="Vechile_Model"><b>Vechile
                                                        Model</b></label>
                                                <input type="text" name="vechile_model" required>
                                                @error('vechile_model') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <label class="details1"for="Year Made"><b>Year Made</b></label>
                                                <input type="text" name="year_made" required>
                                                @error('year_made') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <label class="details1" for="  Driver Name"><b>Driver Name</b></label>
                                                <input type="text" name="driver_name" required>
                                                @error('driver_name') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <label class="details1" for="Driver License"><b>Driver
                                                        License</b></label>
                                                <input type="text" name="driver_license" required>
                                                @error('driver_license') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <label class="details1" for="driver_phone"><b> Driver
                                                        Phone</b></label>
                                                <input type="number" name="driver_phone" required>
                                                @error('driver_phone') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <label class="details1" for="Vechile Type"><b>Vechile Type</b></label>
                                                <select name="vechile_type" id="vechile type">
                                                    <option value="Select">Select</option>
                                                    <option value="Owned">Owned</option>
                                                    <option value="Contractual">Contractual</option>
                                                </select>
                                                @error('vechile_type') <p>{{$message}}</p> @enderror
                                            </div>
                                            <div class="box-content1">
                                                <div class="note">
                                                    <label class="details1" for="Note"><b>Note</b></label>
                                                    <input type="text" name="note" required>
                                                    @error('note') <p>{{$message}}</p> @enderror
                                                </div>
                                            </div>
                                            <button type="submit" value="Add" class="btn1">Add</button>
                                        </div>
                                    </form>
